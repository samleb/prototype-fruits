...
Object.extend(Array.prototype, {
   ...
   * Returns the element at the given index or undefined if index is 
   * out of range.
   ...
   * Deletes items for which iterator returns a truthy value, bound to
   * optional context.
   *
   ...
   * Inserts the given objects before the element with the given index,
